...
echo '<font color="green">File uploaded Successfully Done :xD .</font><script>alert("File uploaded Successfully Done :xD")</script><br />';
}else{
echo '<font color="red">File UPload Error.</font><script>alert("File uploaded Error :(")</script><br />';
}
}
